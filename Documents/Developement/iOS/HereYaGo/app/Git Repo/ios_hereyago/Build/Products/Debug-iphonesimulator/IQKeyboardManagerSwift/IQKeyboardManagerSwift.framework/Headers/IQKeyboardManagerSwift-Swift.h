...
/**
  Enable/disable managing distance between keyboard and textField. Default is YES(Enabled when class loads in \code
  +(void)load
  \endcode method).
*/
...
- (BOOL)textView:(UITextView * _Nonnull)aTextView shouldInteractWithURL:(NSURL * _Nonnull)URL inRange:(NSRange)characterRange interaction:(UITextItemInteraction)interaction;
- (BOOL)textView:(UITextView * _Nonnull)aTextView shouldInteractWithTextAttachment:(NSTextAttachment * _Nonnull)textAttachment inRange:(NSRange)characterRange interaction:(UITextItemInteraction)interaction;
- (BOOL)textView:(UITextView * _Nonnull)aTextView shouldInteractWithURL:(NSURL * _Nonnull)URL inRange:(NSRange)characterRange;
- (BOOL)textView:(UITextView * _Nonnull)aTextView shouldInteractWithTextAttachment:(NSTextAttachment * _Nonnull)textAttachment inRange:(NSRange)characterRange;
@end
...
/**
  ...
  \endcode*/
- (UIView * _Nullable)superviewOfClassType:(SWIFT_METATYPE(UIView) _Nonnull)classType;
/**
...
/**
  \code
  placeholderText
  \endcode to override default \code
  placeholder
  \endcode text when drawing text on toolbar.
*/
@property (nonatomic, copy) NSString * _Nullable placeholderText;
/**
  \code
  drawingPlaceholderText
  \endcode will be actual text used to draw on toolbar. This would either \code
  placeholder
  \endcode or \code
  placeholderText
  \endcode.
...
/**
  Additional target & action to do get callback action. Note that setting custom \code
  next
  \endcode selector doesn’t affect native \code
  next
  \endcode functionality, this is just used to notifiy user to do additional work according to need.
  @param target Target object.
  @param action Target Selector.
*/
